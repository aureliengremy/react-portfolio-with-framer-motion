...
const MySkills = () => {
  ...
  return (
    <section id="skills" className="pt-10 pb-24 h-full flex flex-col justify-center">
      <div>
          ...
          >
            <div className="relative">
              ...
              <p className="mt-5 md:mt-10">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Nesciunt tenetur sed rem libero deserunt id tempora consectetur
                vero laboriosam, quaerat ullam facere porro fugiat at dolore
                minus, amet earum beatae.
              </p>
            </div>
          </motion.div>
          {/* INNOVATIVE */}
          ...
          >
            <div className="relative">
              ...
              <p className="mt-5 md:mt-10">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Nesciunt tenetur sed rem libero deserunt id tempora consectetur
                vero laboriosam. Nesciunt tenetur sed rem libero deserunt id
                tempora consectetur vero laboriosam.
              </p>
            </div>
          </motion.div>
        </div>
